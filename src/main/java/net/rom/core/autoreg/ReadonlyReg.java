...
public class ReadonlyReg {
    ...
    private final Map<Class<? extends IForgeRegistryEntry<?>>, Consumer<ReadonlyReg>> registrationHandlers = new HashMap<>();
     ...
     */
    public void addRegistrationHandler(Consumer<ReadonlyReg> registerFunction, Class<? extends IForgeRegistryEntry<?>> registryClass) throws RuntimeException {
     ...
     * ReadonlyRegistry is constructed.

     */
    public static class EventHandler {
        private final ReadonlyReg ModRegistry;

        public EventHandler(ReadonlyReg ModRegistry) {
