...
import net.rom.core.command.CommandData;
import net.rom.core.network.NHandler;
import net.rom.core.proxy.LibCommonProxy;
...
public class ReadOnlyCore implements IMod{
	...
	public static final String SERVER_PROXY_CLASS = "net.rom.core.proxy.LibServerProxy";
	public static final String CLIENT_PROXY_CLASS = "net.rom.core.proxy.LibClientProxy";
