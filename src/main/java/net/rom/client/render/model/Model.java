package net.rom.client.render.model;
...
public abstract class Model extends ModelBase {
	 ...
	 * 
	 * @param obj    - The Object instance being rendered.
	 */
	 ...
	 * mappings. Calls the superclass method.
	 *
	 * @param entityLiving       - The EntityLiving instance currently being
	 *                           rendered.
	 * @param swingProgress      - The arm swing progress of the Entity being
	 *                           rendered.
	...
	public static float getIdleProgress(EntityLivingBase base) {
		return base.ticksExisted + CoreUtil.getPartialTicks();
	}
	...
	public static float getSwingProgress(EntityLivingBase base) {
		return base.limbSwing - base.limbSwingAmount * (1.0F - CoreUtil.getPartialTicks());
	}
	...
	public static float getSwingProgressPrev(EntityLivingBase base) {
		return base.prevLimbSwingAmount
				+ (base.limbSwingAmount - base.prevLimbSwingAmount) * CoreUtil.getPartialTicks();
	}
	...
	public static float getHeadPitch(EntityLivingBase base) {
		return (base.prevRotationPitch + (base.rotationPitch - base.prevRotationPitch) * CoreUtil.getPartialTicks());
	}
