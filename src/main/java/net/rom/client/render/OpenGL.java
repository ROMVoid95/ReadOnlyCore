...
import net.rom.tile.IRotatableXAxis;
import net.rom.tile.IRotatableYAxis;
...
public class OpenGL
{
	 ...
	 *
	 * @param id the new active texture
	 */
	...
	{
		Object object = CoreUtil.getMinecraft().getTextureManager().getTexture(resource);
