...
import net.rom.libs.space.world.EnumOreGen;

public abstract class BiomeDecoratorFixedBase extends BiomeDecorator {
	...
	protected void generateLapis(WorldGenerator generator, EnumOreGen oreGen, World world, Random rand) {
		this.generateLapis(generator, oreGen.getBlockCount(), oreGen.getMinHeight(), oreGen.getMaxHeight(), world,
				rand);
	}
