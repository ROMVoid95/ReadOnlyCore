...
public interface IEnumItems<E extends Enum<E>, I extends Item> extends IStringSerializable {
    ...
    /**
     * The Class RegistrationHelper.
     */
    class RegistrationHelper {
        
        /** The registry. */
        private final ReadOnlyRegistry registry;

        /**
         * Instantiates a new registration helper.
         *
         * @param registry the registry
         */
        public RegistrationHelper(ReadOnlyRegistry registry) {
