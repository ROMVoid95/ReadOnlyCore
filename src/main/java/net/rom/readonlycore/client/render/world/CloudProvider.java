...
public abstract class CloudProvider extends IRenderHandler implements ICloudProvider
{
	...
	{
		World world = CoreUtil.getMinecraft().world;

		if (world != null && !CoreUtil.getMinecraft().isGamePaused())
		{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		if (world.provider instanceof IClimateProvider)
		{
			...
			{
				if (CoreUtil.getMinecraft().gameSettings.shouldRenderClouds() >= 1)
				{
					OpenGL.pushMatrix();
					{
	...
	public void renderClouds(float renderPartialTicks)
	{
		...
		float cloudHeight = CoreUtil.getMinecraft().world.provider.getCloudHeight() - yOffset + 0.33F;
