...
public class Screen
{
	...
	{
		File file = new File(CoreUtil.getMinecraft().gameDir.getPath());
		...
		if (CoreUtil.getMinecraft().ingameGUI != null && Keyboard.isKeyDown(Keyboard.KEY_F3) && Keyboard.isKeyDown(Keyboard.KEY_U))
		{
			try
			{
