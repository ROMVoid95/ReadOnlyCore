...
public class ResourceLoc {
	...
	public ResourceLoc(String path) {
		this.path = path;
	}
	 ...
	 * 
	 * After loading the texture, {@code ResourceLoc.isReady()} will return true.
	 * 
	...
	public void loadTexture() {
		...
		try {
			...
			location = Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation(f.getName(), new CleaningDynamicTexture(i));
			loaded = true;
