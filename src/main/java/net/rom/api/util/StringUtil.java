...
public final class StringUtil {
	...
	public static String getScaledNumber(long number) {
		...
		if (number >= 1000000000) {
			return number / 1000000000 + "." + (number % 1000000000 / 100000000) + (number % 100000000 / 10000000)
					+ "G";
	...
	public static String getRarity(int level) {
		...
		switch (level) {
		case 2:
			return StringUtil.YELLOW;
		case 3:
			return StringUtil.BRIGHT_BLUE;
		default:
			return StringUtil.LIGHT_GRAY;
		}
	}
